import style from '@stimulcross/eslint-config-base/style';
...
const config = {
	...
	rules: {
		...
		'@stylistic/padding-line-between-statements': [
			...style.rules['@stylistic/padding-line-between-statements'],
			{
				blankLine: 'always',
				prev: '*',
				next: ['enum', 'type', 'interface'],
			},
			{
				blankLine: 'always',
				prev: ['enum', 'type', 'interface'],
				next: '*',
			},
			{
				blankLine: 'any',
